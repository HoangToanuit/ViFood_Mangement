...
Route::group(['namespace' => 'Api\V1'], function () {
       ...
       Route::group(['prefix' => 'products'], function () {
        Route::get('popular', 'ProductController@get_popular_products');
         Route::get('recommended', 'ProductController@get_recommended_products');
	      Route::get('drinks', 'ProductController@get_drinks');
           Route::get('food1','ProductController@get_popular_VNF');
            Route::get('food2','ProductController@get_recommended_VNF');
        ...
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api','json.force'], function () {
